What did you enjoy about using the chosen framework?

Using react I enjoyed how the react framework pre-loaded everything needed to port the js/html files to a browser.
I also like the different accessibility features that allowed integrating the tab and enter buttons from the keyboard easy.

What you dislike?

I did not like the error handling of the framework. It would be nice if the framework would be able to catch generic errors for you
and then throw a more specific/intuitive error discription than the brower.
